...
def heatmap_generator(df_type: str,
    ...
    intersec_lookup = {
        ...
        5060: "SW 13th St and University Ave"
    }
    ...
    try:
        ...
        raise ValueError(f"Intersection {intersec_id} or period '{period}' not found in times_dict.")
...
for inter in [3287, ]:  # or your list of IDs
